                ...
                <div key={video.id} className="group cursor-pointer" onClick={() => handleVideoClick(video)}>
                  <div className="relative overflow-hidden rounded-lg aspect-video">
                    ...
                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                      <div className="w-12 h-12 md:w-16 md:h-16 bg-amber-500/90 rounded-full flex items-center justify-center group-hover:bg-amber-400 transition-colors">
                        <Play className="w-4 h-4 md:w-6 md:h-6 text-black ml-1" fill="currentColor" />
                      </div>
                    </div>
                    <div className="absolute bottom-2 md:bottom-4 left-2 md:left-4 right-2 md:right-4">
                      <h3 className="text-white font-semibold text-sm md:text-lg mb-1">{video.title}</h3>
                      <p className="text-amber-400">{video.duration}</p>
                    </div>
                  </div>
                </div>
              ))}
